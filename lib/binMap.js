...
var request = require('request'),
     ...
     * returns Object
     */
    convertLocationsAndOptionsToQueryStringArgs = function(locations, options) {
 ...
 * @since 0.0.6
 */
exports.getDrivingRoute = function(locations, callback) {
    var options = getDefaultDrivingOptions(),
        queryStringArgs = convertLocationsAndOptionsToQueryStringArgs(locations, options),
